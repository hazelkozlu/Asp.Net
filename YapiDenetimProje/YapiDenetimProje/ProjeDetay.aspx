<%@ Page Title="" Language="C#" MasterPageFile="~/AnaProje.Master" AutoEventWireup="true" CodeBehind="ProjeDetay.aspx.cs" Inherits="YapiDenetimProje.ProjeDetay" %>
    ...
    <form id="Form1" runat="server">
        <div class="form-group">
            ...
            <div>
                ...
                <asp:TextBox ID="TxtProjeAd" runat="server" CssClass="form-control"></asp:TextBox>
            ...
            <div>
                ...
                <asp:TextBox ID="TxtMevki" runat="server" CssClass="form-control"></asp:TextBox>
            ...
            <div>
                ...
                <asp:TextBox ID="TxtParsel" runat="server" CssClass="form-control"></asp:TextBox>
            ...
            <div>
                ...
                <asp:TextBox ID="TxtElkProNusha" runat="server" CssClass="form-control"></asp:TextBox>
            ...
            <div>
                ...
                <asp:TextBox ID="TxtElkProDurum" runat="server" CssClass="form-control"></asp:TextBox>
            ...
            <div>
                ...
                <br />
                <asp:TextBox ID="TxtElkProOnyTar" runat="server"></asp:TextBox>
            ...
            <div>
                ...
                <asp:TextBox ID="TxtTelProNusha" runat="server" CssClass="form-control"></asp:TextBox>
            ...
            <div>
                ...
                <asp:TextBox ID="TxtTelProDurum" runat="server" CssClass="form-control"></asp:TextBox>
            ...
            <div>
                ...
                <br />
                <asp:TextBox ID="TxtTelProOnyTar" runat="server"></asp:TextBox>
            ...
            <div>
                ...
                <asp:TextBox ID="TxtKontFormu" runat="server" CssClass="form-control"></asp:TextBox>
            ...
            <div>
                ...
                <asp:TextBox ID="TxtTedasDosya" runat="server" CssClass="form-control"></asp:TextBox>
            ...
            <div>
                ...
                <asp:TextBox ID="TxtElektrikciAd" runat="server" CssClass="form-control"></asp:TextBox>
            ...
            <div>
                ...
                <asp:TextBox ID="TxtIletisim" runat="server" CssClass="form-control"></asp:TextBox>
            ...
            <br />
            <asp:Button ID="Button1" runat="server" Text="Sil" CssClass="btn btn-danger" OnClick="Button1_Click1" />
            </>
            <asp:Button ID="Button2" runat="server" Text="Güncelle" CssClass="btn btn-info" OnClick="Button2_Click" />
            </>
            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Default.aspx" CssClass="btn btn-primary">Listeye Geri Dön</asp:HyperLink>
