<%@ Page Title="" Language="C#" MasterPageFile="~/AnaProje.Master" AutoEventWireup="true" CodeBehind="SilinenProjelerDetay.aspx.cs" Inherits="YapiDenetimProje.SilinenProjelerDetay" %>
    ...
    <form id="Form1" runat="server">
        <div class="form-group">
            ...
            <div>
                ...
                <%--<asp:Button ID="BtnElkOnyTar" runat="server" Text="Tarih Seç"  />--%>
            ...
            <div>
                ...
                <asp:TextBox ID="TxtTelProOnyTar" runat="server" Enabled="False"></asp:TextBox>
                 <%--<%-- <asp:Button ID="BtnTelOnyTar" runat="server" Text="Tarih Seç"  />
            ...
            <div>
                ...
                <textarea id="TextArea1" cols="20" rows="6" class="form-control" runat="server" enableviewstate="False"></textarea>
            ...
            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/SilinenProjeler.aspx" CssClass="btn btn-primary">Listeye Geri Dön</asp:HyperLink>
